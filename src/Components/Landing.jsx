            ...
            <div className="w-full absolute top-0 mt-10">
                <div className="text text-white  max-w-screen-2xl h-full mx-auto px-5 sm:px-10 sm:ml-10">
                    <div className="para mt-72 sm:mt-[35rem]">
                        <p className='text-md sm:text-2xl '> Global digital design studio partnering with  <br /> brands and businesses that create exceptional <br /> experiences where people live, work, and unwind. </p>
                       
                    </div>
                    <div className="heading mt-5 sm:mt-10">
                        <h1 className='text-6xl sm:text-[17rem] font-light tracking-tighter leading-none'>Digital <br />Design <br /> Experience</h1>
